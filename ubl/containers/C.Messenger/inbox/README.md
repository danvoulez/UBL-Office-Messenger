![inbox • * Verde (Público)](https://img.shields.io/badge/inbox-*%20Verde%20(Público)-brightgreen)

# C.Messenger/inbox — Você está aqui

**Path:** `containers/C.Messenger/inbox`  
...
- Átomos aceitos + metadados de commit
