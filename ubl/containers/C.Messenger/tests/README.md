![tests • * Verde (Público)](https://img.shields.io/badge/tests-*%20Verde%20(Público)-brightgreen)

# C.Messenger/tests — Você está aqui

**Path:** `containers/C.Messenger/tests`  
...
- Eventos simulados / asserts de borda
