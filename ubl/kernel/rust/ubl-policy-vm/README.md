![ubl-policy-vm • * Kernel (neutro)](https://img.shields.io/badge/ubl-policy-vm-*%20Kernel%20(neutro)-lightgrey)

# ubl-policy-vm — Você está aqui

**Path:** `kernel/rust/ubl-policy-vm`  
...
## Função
Executor WASM TDLN (determinístico, sem semântica)
