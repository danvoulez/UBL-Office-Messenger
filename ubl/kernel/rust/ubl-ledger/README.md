![ubl-ledger • * Kernel (neutro)](https://img.shields.io/badge/ubl-ledger-*%20Kernel%20(neutro)-lightgrey)

# ubl-ledger — Você está aqui

**Path:** `kernel/rust/ubl-ledger`  
...
## Função
Append-only + verificação causal/offline
